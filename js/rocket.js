...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var closedButtonbtn = document.querySelector('.closed-button-btn');
    ...
    function updateChecklist() {
        ...
        const checklistHtml = checklistItems.map((item, index) => `
            <label style="display: flex;color:#012e5d; font-size:24px; align-items: center;">
        ...
        description.innerHTML = `<div class="checklist" style="font-size:30px;">${checklistHtml}</div>`;
...
         });
    ...
    launchBtn.addEventListener("click", function () {
        ...
        container.style.backgroundImage = "url('./images/banner-8.png')";
        container.style.backgroundSize = "100% 100%";
        // Set the HTML content with "Launching" and the loader
        description.innerHTML = `
      <span style="font-size:36px; font-weight:500; color:#000000;">Launching</span>
        ...
        setTimeout(function () {
          gsap.to([svgs[5]], {
            ...
            onStart: function () {
              ...
              setTimeout(function () {
                description.innerHTML =
                  '<span style="font-size:36px; font-weight:500;color:#000000;">Your Business has been Launched</span>';
